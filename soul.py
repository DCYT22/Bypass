...
TOKEN = '7338146310:AAHFiwGMI-H7Of3s0K8zkELUyz6XwKgbWv4'
...
FORWARD_CHANNEL_ID = -1002201149648
CHANNEL_ID = -1002201149648
error_channel_id = -1002201149648
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/DCYTHACKS*", parse_mode='Markdown')
